...
export class BackgroundScene {
    constructor(/** @type {StartScene} */game) {
        ...
        this.jupiterPng.src = "https://medarwin.github.io/jupiter-hitter/assets/img/jupiter.png";
        this.bgMusic = new Audio();
        this.bgMusic.src = "https://medarwin.github.io/jupiter-hitter/assets/audio/bg.mp3";
